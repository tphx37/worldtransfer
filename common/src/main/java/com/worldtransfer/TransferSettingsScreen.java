...
public class TransferSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        addToggle("Carry over cheats: " + onOff(settings.carryCheats), y,
            ...
            "Controls whether the transferred world keeps command access for LAN guests.");
        y += 40;
    ...
    private void addToggle(String label, int y, Runnable action) {
        addToggle(label, y, action, null);
    }

    private void addToggle(String label, int y, Runnable action, String tooltip) {
